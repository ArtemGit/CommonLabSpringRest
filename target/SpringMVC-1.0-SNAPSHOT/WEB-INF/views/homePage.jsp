                    ...
                    <div class="navbar-collapse collapse">
                        <ul class="nav navbar-nav">
                            ...
                            <li><a ng-click="showFormRegistration()" href="#" class="smoothScroll "
                                   data-placement="bottom"
                                   data-toggle="tooltip"
                                   data-original-title="Предоставляет расширенную информацию об реализуемом имуществе">Регистрация</a></li>
                        </ul>
                    </div><!--/.nav-collapse -->
...
<div class="container" id="about" name="about">
    <div class="row white">
        ...
        <div class="col-lg-6">
            <p>Из-за специфики работы банка мы выдаём кредиты..., и зачастую организации в качестве залога для кредита
                предоставляют банку возможность, прописывая в договоре выдачи кредита, изъять прописанное в договоре
                имущество предприятия-организации. Однако,чтобы его реализовать необходимо список реализуемого имущества
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4">
                ...
                <p>Вы хотите просмотреть список товаров? Узнать, как связаться с нами? Мы работаем каждный день(кроме
